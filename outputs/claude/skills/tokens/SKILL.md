---
name: tokens
description: Extract and systematize design tokens from existing interfaces into a
  reliable design system foundation
command: /tokens
aliases:
- /design-tokens
...
- Coordinate with the `/ux` and `/polish` workflows:
