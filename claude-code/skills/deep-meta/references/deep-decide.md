...
- Use `/deep-consider` if the option space or context is complex.
...
- Use `/deep-search`, `/deep-experiment`, or `/deep-investigate` to reduce uncertainty.
